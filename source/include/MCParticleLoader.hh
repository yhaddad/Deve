  /// \file MCParticleLoader.hh
/*
 *
 * MCParticleLoader.hh header template generated by fclass
...
#ifndef MCPARTICLELOADER_HH
#define MCPARTICLELOADER_HH
...
namespace deve {
	...
	/*!
	*
	* @brief  MCParticleLoader class
	* Inherits from base class ObjectLoader
	*
	*/
	class MCParticleLoader : public ObjectLoader {
		...
		public:
			...
			*/
			MCParticleLoader()
			: ObjectLoader( EVENT::LCIO::MCPARTICLE ) {}
