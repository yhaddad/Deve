  /// \file VertexLoader.hh
/*
 *
 * VertexLoader.hh header template generated by fclass
...
#ifndef VERTEXLOADER_HH
#define VERTEXLOADER_HH
...
namespace deve {
	...
	/*!
	*
	* @brief  VertexLoader class
	* Inherits from base class ObjectLoader
	*
	*/
	class VertexLoader : public ObjectLoader {
		...
		public:
			...
			*/
			VertexLoader()
			: ObjectLoader( EVENT::LCIO::VERTEX ) {}
