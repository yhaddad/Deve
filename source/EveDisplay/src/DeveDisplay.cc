...
DeveDisplay::DeveDisplay()
{
  ...
  packH->SetElementName("Deve Display");
  packH->SetHorizontal();
...
void DeveDisplay::ImportGeomRPhi(TEveElement* el)
{ 
  fRPhiMgr->ImportElements(el, fRPhiGeomScene);
}

void DeveDisplay::ImportGeomRhoZ(TEveElement* el)
{ 
  fRhoZMgr->ImportElements(el, fRhoZGeomScene);
}

void DeveDisplay::ImportCaloRPhi(TEveCalo3D *calo)
{
  fRPhiMgr->ImportElements(calo, fRPhiCaloScene);
}

void DeveDisplay::ImportCaloRhoZ(TEveCalo3D *calo)
{
  fRhoZMgr->ImportElements(calo, fRhoZCaloScene);
}

void DeveDisplay::ImportCaloLego(TEveCaloLego *calo)
{
...
void DeveDisplay::ImportEventRPhi(TEveElement* el)
{ 
  fRPhiMgr->ImportElements(el, fRPhiEventScene);
}

void DeveDisplay::ImportEventRhoZ(TEveElement* el)
{ 
...
void DeveDisplay::DestroyEventRPhi()
{
  fRPhiEventScene->DestroyElements();
}

void DeveDisplay::DestroyEventRhoZ()
{
